...
class Signup_model extends Base_Model {
    ...
    public function insertUserInfo($register) { 
        ...
        $register['address'] = htmlentities($register['address']);
        ...
        $data = array(
            ...
            'under_group' => $register['under_group'],
            're_pay' => $register['re_pay'],
            'open_bal' => $register['open_bal']
        );
    ...
    public function insertLoginInfo($register) {
        ...
        $this->db->set('staff_id',$register['staff_id']);
        if (array_key_exists('subadmin', $register)) {
            $this->db->set('sub_id',$register['subadmin']);
        }
        if (array_key_exists('vehicle_id', $register)) {
            $this->db->set('vehicle_id',$register['vehicle_id']);
        }

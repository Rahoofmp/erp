							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group row mb-2">
										...
										<div class="col-lg-9">
											<input id="party_name" name="party_name" type="text" class="form-control" value="{$party_details['name']}">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group row mb-2">
										...
										<div class="col-lg-9">
											<input id="txtDate" name="as_date" type="date" value="{$party_details['as_date']}" class="form-control">
											{form_error('as_date')}

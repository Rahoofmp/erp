	...
	<script type="text/javascript">
		...
		$(document).ready(function(){ 
			...
			var order = $('#customer_list').DataTable({
				...
				'ajax': {
					'url':'{base_url()}admin/settings/get_vehicle_list_ajax',
					"type": "POST", 
					"data" : {
						
						'vehicle_id' : '{$search_arr['vehicle_id']}',
						'vehicle_id' : '{$search_arr['vehicle_id']}',
				...
				'columns': [
					...
					{ data: 'status'},
					{
						mRender: function(data, type, row) {
							var link = '<a href = "add-vehicle/' + row.enc_vehicleid +'" class="btn-sm btn btn-info btn-link" data-placement="top" title ="Edit" target="_blank"><i class="iconoir-edit-pencil" aria-hidden="true"></i></a>';

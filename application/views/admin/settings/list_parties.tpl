				...
				<div class="card-body"> 
					...
					<div class="form-body">
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label for="staff_id">Party Name</label>
								...
								<div class="form-group row mb-2">
									...
									<div class="col-lg-9">
										<select id="type" name="type" class="form-control">
											...
											<option value="1" {if $search_arr['type']=='1'} selected {/if}>Purchase</option>
											<option value="2" {if $search_arr['type']=='2'} selected {/if}>Sales</option>
										</select> 
									</div>
								</div>
							</div>
							...
							<div class="col-md-2">
								<div class="form-group row mb-2">
									<label for="staff_id">Status</label>
									<div class="col-lg-9">
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){ 
			...
			var order = $('#customer_list').DataTable({
				...
				'ajax': {
					'url':'{base_url()}admin/settings/get_party_list_ajax',
					"type": "POST", 
					"data" : {
						
						'party_id' : '{$search_arr['party_id']}',
				...
				'columns': [
					...
					{ data: 'status'},
					{
						mRender: function(data, type, row) {
							var link = '<a href = "add-party/' + row.enc_party_id +'" class="btn-sm btn btn-info btn-link" data-placement="top" title ="Edit" target="_blank"><i class="iconoir-edit-pencil" aria-hidden="true"></i></a>';
